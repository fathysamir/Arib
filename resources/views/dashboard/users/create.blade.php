...
@section('title', 'Dashboard - create employee')
@section('content')	
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card">
                      ...
                      <div class="form-group">
                        <label>Salary</label>
                        <input type="number" name="salary" class="form-control"  placeholder="Enter Salary"value="{{ old('salary') }}">
                      ...
                      <div class="form-group" id="manager_div" style="display: none;">
                        ...
                        <select class="form-control" name="manager">
                          ...
                          <option value="{{$manager->id}}" @if(old('manager')==$manager->id) selected @endif>{{$manager->first_name}} {{$manager->last_name}}</option>
                          @endforeach
                        </select>
