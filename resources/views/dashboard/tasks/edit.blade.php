...
@section('title', 'Dashboard - edit task')
@section('content')	
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card">
                      ...
                      <hr>
                       <form method="post" action="{{route('update.task',['id' => $task->id])}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="users" class="col-sm-2 col-form-label">employees</label>
                       
                            <select class="form-control" id="users" name="users[]" multiple>
                                @foreach ($employees as $employee)
                                    <option value="{{ $employee->id }}" {{ in_array($employee->id, old('users', [])) || in_array($employee->id, $task->users->pluck('id')->toArray())  ? 'selected' : '' }}>
                        ...
                        <div class="form-group py-2">
                            <div class="icheck-material-white">
                                <input type="checkbox"name="is_active" id="user-checkbox2" @if($task->is_active==1) checked @endif/>
