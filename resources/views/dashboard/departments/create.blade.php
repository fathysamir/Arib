...
@section('title', 'Dashboard - create department')
@section('content')	
        ...
        <div class="container-fluid">
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                      <div class="card-title">Create New department</div>
                      <hr>
                       <form method="post" action="{{route('create.department')}}" enctype="multipart/form-data">
                        @csrf
