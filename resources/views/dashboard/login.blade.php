...
<head>
  ...
  <title>@yield('title', 'Arib')</title>
  <!-- loader-->
  <link href="assets/css/pace.min.css')}}" rel="stylesheet"/>
  <script src="assets/js/pace.min.js')}}"></script>
  <!--favicon-->
  <link rel="icon" type="image/x-icon" href="{{asset('dashboard/assets/assets/imgs/logo.webp')}}">
  <!-- Bootstrap core CSS-->
		...
		<div class="card-body">
		 <div class="card-content p-2">
		 	<div class="text-center">
		 		<img src="{{asset('dashboard/assets/assets/imgs/logo.webp')}}" alt="logo icon"style="width:50%; border-radius:50%;">
		 	</div>
